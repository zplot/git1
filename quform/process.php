 ...
 */
$config['successMessage'] = 'Sus datos han sido enviados, gracias.';
 ...
 * );
 */
$config['recipients'] = 'luis.fontes@grupo51.com';
 ...
 * $config['from'] = '%email%';
 */
$config['from'] = 'formulario_web@redncf.com';
...
$pais = new Quform_Element('pais', 'País');
$pais->addFilter('trim');
$pais->addValidator('required');
$form->addElement($pais);


$apellidos = new Quform_Element('apellidos', 'Apellidos');
$apellidos->addFilter('trim');
$apellidos->addValidator('required');
$form->addElement($apellidos);


$nombre = new Quform_Element('nombre', 'Nombre');
$nombre->addFilter('trim');
$nombre->addValidator('required');
...
$centro = new Quform_Element('centro', 'Centro');
$centro->addFilter('trim');
//$name->addValidator('required');
$form->addElement($centro);


$estado = new Quform_Element('estado', 'Estado o provincia');
$estado->addFilter('trim');
//$name->addValidator('required');
$form->addElement($estado);


$consentimiento = new Quform_Element('consentimiento', 'Doy mi aprobación');
$consentimiento->addValidator('required');
$form->addElement($consentimiento);
...
$captcha->addValidator('identical', array('token' => 'vida'));
