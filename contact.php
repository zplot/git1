...
if($_POST)
{
    $to_Email   	= "luis.fontes@grupo51.com"; //Replace with recipient email address
    $subject        = 'Mensaje enviado desde la web de la Red NCF'; //Subject line for emails
...
//        die($output);
    ...
    $headers = "From: " . "formulario_web@redncf.com" . "\r\n";
    ...
    /*$headers = 'From: 'formulario_web@redncf.com'' . "\r\n" .
    'Reply-To: 'formulario_web@redncf.com'' . "\r\n" .
    ...
    */
    ...
    if(!$sentMail)
    {
        ...
        /* Redirect browser */
        header("Location: http://redncf.com");
